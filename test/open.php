<?php
	...
	$sql = "select * from boardgame_info order by BID DESC";
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="pinterest_grid/css/default.css">
	...
	<style type="text/css">
		...
		{
			#gallery-wrapper{max-width:100%;width: 100%;}
...
<body class="page-body horizontal-menu-skin-white" onload="show()">
	...
	<div class="page-container container">
		...
		<div class="main-content" >
			...
			<?php				
				...
				//echo $json_string[0]->name;	
				for($i = 0 ;$i < $num;$i++)
				{
					echo "<article class='white-panel'>";
						echo "<a href='full_blog.php?BID=".$json_string[$i]->BID."'><img src='".$json_string[$i]->main_img."' class='thumb'>";
						echo "<h1>".$json_string[$i]->name."</h1>";
						echo "<p>Description 1</p></a>";
					echo "</article>";
				}
				//echo $num;
			?>
	...
	<script src="pinterest_grid/js/pinterest_grid.js"></script>
